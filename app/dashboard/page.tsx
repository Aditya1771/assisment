    ...
    <div>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <Link
          ...
          className="block p-8 rounded-2xl border-2 border-blue-200 bg-white hover:border-blue-400 hover:shadow-lg transition"
        >
          <span className="text-4xl">📧</span>
          <h2 className="mt-4 text-xl font-bold text-ink-900">Gmail Inbox</h2>
          <p className="mt-2 text-ink-600">
            Generate AI marketing messages and send via Gmail with subject line.
          </p>
          <span className="inline-block mt-4 text-primary-600 font-medium">
            Open Gmail Inbox →
          </span>
